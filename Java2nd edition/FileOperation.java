...
if(   JOptionPane.showConfirmDialog(  
    this.npd.f,""+temp.getPath()+" already exists.<br>Do you want to replace it?",  
...
JOptionPane.showMessageDialog(this.npd.f,  
    ""+temp.getName()+"<br>file not found.<br>"+  
...
boolean confirmSave()  
{  
String strMsg="The text in the "+fileName+" file has been changed.<br>"+  
